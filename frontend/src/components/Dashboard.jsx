          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div className="flex gap-3">
              ...
              >
                ...
                {syncing ? 'Syncing...' : 'Sync Shopify API'}
              </Button>
              ...
              <label htmlFor="csv-upload">
                <Button 
                  ...
                  disabled={uploading}
                  size="lg"
                  className="bg-green-600 hover:bg-green-700 text-white font-medium px-6 shadow-lg shadow-green-200 transition-all hover:shadow-xl cursor-pointer"

  ...
  const handleNext = async () => {
    ...
    try {
      ...
      if (currentStep === 5) {
        ...
        toast.success('Onboarding complete! Welcome to Importaba.');
        navigate('/dashboard');
        return;
      }
      ...
      <div className="border-b border-white/10 px-6 py-4">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold">Importaba</span>
          </div>
        ...
        {currentStep === 1 && (
          <div className="space-y-8">
            <div className="text-center">
              ...
              <p className="text-gray-400">This helps us customize Importaba for your needs</p>
            </div>

    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200 px-8 py-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-semibold text-gray-900">Purchase Tracker</h1>
            <p className="text-sm text-gray-500 mt-1">Track supplier purchase orders and inventory sourcing from China</p>
          </div>

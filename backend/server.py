...
@api_router.get("/facebook/ad-accounts")
...
@api_router.post("/facebook/set-ad-account")
...
@api_router.get("/facebook/campaigns")
...
@api_router.get("/facebook/campaigns/{campaign_id}/insights")
...
@api_router.get("/facebook/campaigns/all/insights")
async def get_all_campaigns_with_insights(date_preset: str = 'last_30d'):
...
@api_router.get("/facebook/account/insights")
...
@api_router.get("/facebook/audiences")
...
@api_router.post("/facebook/audiences/create")
...
@api_router.post("/facebook/audiences/{audience_id}/add-customers")
...
@api_router.post("/facebook/audiences/sync-store")

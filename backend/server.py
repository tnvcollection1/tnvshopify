...
# Note: create_product_variants endpoint moved to routes/shopify_products.py
...
# NOTE: Marketing endpoints moved to /app/backend/routes/marketing.py
# The following duplicates were removed:
# - GET /marketing/stats  
...
# NOTE: WhatsApp Marketing endpoints moved to /app/backend/routes/whatsapp_api.py
# The following duplicates were removed:
# - POST /whatsapp/marketing/send
# - POST /whatsapp/marketing/campaign
...
# NOTE: Settings endpoints moved to /app/backend/routes/settings.py
# The following duplicates were removed:
# - GET /settings/auto-sync
# - POST /settings/auto-sync  
# - POST /settings/auto-sync/trigger
...
app.include_router(ai_product_editor_router)
...
app.include_router(image_proxy_router, prefix="/api/images", tags=["Images"])

...
async def get_authorize_url(
    redirect_uri: str = Query("https://carrier-connect-18.preview.emergentagent.com/api/1688/auth/callback", description="Callback URL after authorization")
):
    """
...
async def oauth_callback(
    ...
    return {
        ...
        "or_use_curl": f"curl -X POST 'https://carrier-connect-18.preview.emergentagent.com/api/1688/auth/exchange-code?code={code}'"
    }
...
async def exchange_code_for_tokens(
    ...
    redirect_uri: str = Query("https://carrier-connect-18.preview.emergentagent.com/api/1688/auth/callback", description="Must match the redirect_uri used in authorize")
):
    """

...
agent_communication:
  ...
  - agent: "main"
    message: "Orders page updated with: (1) Stats cards showing fulfilled/unfulfilled/cancelled counts correctly, (2) New columns added: Sale, Cost, Profit, Stock, (3) Sync Costs button added to sync order costs from inventory, (4) Cancelled filter now working - includes restocked orders, (5) Backend updated with sync-order-costs endpoint - 936 orders synced for tnvcollectionpk store with total cost ₹49,54,202"
  - agent: "testing"

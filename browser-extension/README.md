...
2. **WaMerce Backend Running** - The extension connects to `https://multistore-ecom-1.preview.emergentagent.com`
...
2. Or navigate to: `https://multistore-ecom-1.preview.emergentagent.com/product-collector`
3. Verify:

...
2. **WaMerce Backend Running** - The extension connects to `https://ecom-platform-192.preview.emergentagent.com`
...
2. Or navigate to: `https://ecom-platform-192.preview.emergentagent.com/product-collector`
3. Verify:

...
2. **WaMerce Backend Running** - The extension connects to `https://shopify1688bridge-1.preview.emergentagent.com`
...
2. Or navigate to: `https://shopify1688bridge-1.preview.emergentagent.com/product-collector`
3. Verify:

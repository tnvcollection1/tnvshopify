...
2. **WaMerce Backend Running** - The extension connects to `https://multi-tenant-shop-3.preview.emergentagent.com`
...
2. Or navigate to: `https://multi-tenant-shop-3.preview.emergentagent.com/product-collector`
3. Verify:

...
2. **WaMerce Backend Running** - The extension connects to `https://logistics-autoflow.preview.emergentagent.com`
...
2. Or navigate to: `https://logistics-autoflow.preview.emergentagent.com/product-collector`
3. Verify:

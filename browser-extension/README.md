...
2. **WaMerce Backend Running** - The extension connects to `https://dwzconnect.preview.emergentagent.com`
...
2. Or navigate to: `https://dwzconnect.preview.emergentagent.com/product-collector`
3. Verify:

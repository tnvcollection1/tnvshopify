...
2. **WaMerce Backend Running** - The extension connects to `https://carrier-connect-18.preview.emergentagent.com`
...
2. Or navigate to: `https://carrier-connect-18.preview.emergentagent.com/product-collector`
3. Verify:

...
2. **WaMerce Backend Running** - The extension connects to `https://multi-shop-24.preview.emergentagent.com`
...
2. Or navigate to: `https://multi-shop-24.preview.emergentagent.com/product-collector`
3. Verify:

...
2. **WaMerce Backend Running** - The extension connects to `https://stock-audit-5.preview.emergentagent.com`
...
2. Or navigate to: `https://stock-audit-5.preview.emergentagent.com/product-collector`
3. Verify:

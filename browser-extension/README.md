...
2. **WaMerce Backend Running** - The extension connects to `https://custom-storefront-2.preview.emergentagent.com`
...
2. Or navigate to: `https://custom-storefront-2.preview.emergentagent.com/product-collector`
3. Verify:

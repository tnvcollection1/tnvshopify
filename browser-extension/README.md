...
2. **WaMerce Backend Running** - The extension connects to `https://multi-tenant-7.preview.emergentagent.com`
...
2. Or navigate to: `https://multi-tenant-7.preview.emergentagent.com/product-collector`
3. Verify:

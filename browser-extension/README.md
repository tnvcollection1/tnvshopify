...
2. **WaMerce Backend Running** - The extension connects to `https://merchant-hub-155.preview.emergentagent.com`
...
2. Or navigate to: `https://merchant-hub-155.preview.emergentagent.com/product-collector`
3. Verify:

...
2. **WaMerce Backend Running** - The extension connects to `https://tenant-storefront.preview.emergentagent.com`
...
2. Or navigate to: `https://tenant-storefront.preview.emergentagent.com/product-collector`
3. Verify:

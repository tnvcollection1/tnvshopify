...
2. **WaMerce Backend Running** - The extension connects to `https://alibaba-sync.preview.emergentagent.com`
...
2. Or navigate to: `https://alibaba-sync.preview.emergentagent.com/product-collector`
3. Verify:

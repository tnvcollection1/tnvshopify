...
2. **WaMerce Backend Running** - The extension connects to `https://ai-product-hub-14.preview.emergentagent.com`
...
2. Or navigate to: `https://ai-product-hub-14.preview.emergentagent.com/product-collector`
3. Verify:

...
2. **WaMerce Backend Running** - The extension connects to `https://tnv-collection.preview.emergentagent.com`
...
2. Or navigate to: `https://tnv-collection.preview.emergentagent.com/product-collector`
3. Verify:

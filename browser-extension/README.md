...
2. **WaMerce Backend Running** - The extension connects to `https://shopfront-editor.preview.emergentagent.com`
...
2. Or navigate to: `https://shopfront-editor.preview.emergentagent.com/product-collector`
3. Verify:

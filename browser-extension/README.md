...
2. **WaMerce Backend Running** - The extension connects to `https://merchant-platform-12.preview.emergentagent.com`
...
2. Or navigate to: `https://merchant-platform-12.preview.emergentagent.com/product-collector`
3. Verify:
